---
title: ¿Cómo afecta la situación familiar y del país a las carreras elegidas por los
  alumnos?
...
ui <- fluidPage(
  titlePanel("Variación de las carreras elegidas por los estudiantes en función de la situación familar y el país"),
  sidebarLayout(
    sidebarPanel(
