...
ggplot(creditos_desplazado, aes(x = CreditsApp, fill = as.factor(Displaced))) +
  ...
  ylab("Frecuencia") +
  ggtitle("Distribución de la media de créditos superados por alumnos desplazados y no desplazados") +
...
ggplot(data = data, aes(x = CreditsApp, group = as.factor(data$`Scholarship holder`), fill = as.factor(data$`Scholarship holder`))) +
  ...
  xlab("Media de créditos aprobados") +
  ylab("Densidad") +
  ggtitle("Densidad de alumnos con media de créditos aprobados dependiendo de si tienen beca")
  theme(
